<template>
  <div>
    ...
    <!--@finish="onFinish">-->
    <!--</xy-time-count>-->
    <div class="lazy-load" style="width: 250px;height: 150px;border: 1px solid blue;">
      <img
        v-lazy="imgTest"
        class="lazy-contain"
        :key="imgTest"
    ...
    <div class="lazy-load" style="width: 30px;height: 30px;border: 1px solid blue;">
      <img
        v-lazy="imgTest2"
        class="lazy-cover"
        :key="imgTest2"
    ...
    <!--v-xy-pop-image:change="onPopChange">-->
    <!--</div>-->
    <button @click="onChangeImg" style="background-color: #eee;padding: 10px;">更换图片</button>
    <xy-scale-slider
      width="640"
      height="290"
      interval="3"
    ...
    <div id="demo">
      <router-link tag="button" to="/page-progress" v-xy-moving-btn>路由加载</router-link>
      ...
      <xy-list-status status="nomore">
        <article slot="nomore" class="nomore">
          <div>
            <div>
              <span>没更多商品了</span>
            </div>
      ...
      <xy-list-status status="empty">
        <img slot="empty" src="./nomore.png" alt="暂无内容" class="empty">
      </xy-list-status>
      <div class="keepTopOther"></div>
      <div id="keepTop" v-xy-keep-top>
